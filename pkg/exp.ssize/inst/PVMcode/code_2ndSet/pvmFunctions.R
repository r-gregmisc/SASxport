...
ncpu <- 16; # gsun374 can take up to 20 cpu's
...
source("/home/liup01/Peng/ssize.parameter.nonull.R")
...
clusterFSExport(cl, c("sd.vector", "cov.list", "ssize.parameter.nonull", "get.plot.comparison"),
                path="/home/liup01" )
 ...
 myssize <- function(vec)
  {
    ...
    var.ratio <- vec[5]
    delta <- vec[6]
    pdf(file = paste("/home/liup01/Peng/result/985Sample/25th/PowSsizePlot",paste(vec,collapse="_"),".pdf"))
    res <- ssize.parameter.nonull(ngenes, nsample.simu, 
